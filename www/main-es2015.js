...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, network, translate, device) {
...
/* harmony import */ var _interceptor_httpconfig_interceptor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./interceptor/httpconfig.interceptor */ "./src/app/interceptor/httpconfig.interceptor.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"],
        ...
        providers: [
            ...
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HTTP_INTERCEPTORS"], useClass: _interceptor_httpconfig_interceptor__WEBPACK_IMPORTED_MODULE_10__["HttpConfigInterceptor"], multi: true }
        ],
        exports: [
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_13__["TranslateModule"]
        ],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LATEST_MOVIE", function() { return LATEST_MOVIE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LIST_MOVIES", function() { return LIST_MOVIES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DETAIL_MOVIE", function() { return DETAIL_MOVIE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INITIAL_PAGES_NUMBER", function() { return INITIAL_PAGES_NUMBER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URL_IMG", function() { return URL_IMG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URL_IMG_DETAIL", function() { return URL_IMG_DETAIL; });
const TOKEN = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhYzg5ZDdmZWFmZjE2NTIwODEyZDEwYzkyNmM4MDIyNSIsInN1YiI6IjVmMmM2ZTQ2OWMyNGZjMDAzNmE0NjY3NiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.rsz6ejTOJzqikoYfjsK3GdqpQqUQGQUK9sSqRSPm0Kw';
const API_URL = 'https://api.themoviedb.org/3/';
const LATEST_MOVIE = 'movie/latest';
const LIST_MOVIES = 'movie/popular?page=';
const DETAIL_MOVIE = '/movie/';
const INITIAL_PAGES_NUMBER = 10;
const URL_IMG = 'https://image.tmdb.org/t/p/w200/';
const URL_IMG_DETAIL = 'https://image.tmdb.org/t/p/w400/';
...
let HttpConfigInterceptor = class HttpConfigInterceptor {
    intercept(request, next) {
        const token = _common_constants__WEBPACK_IMPORTED_MODULE_3__["TOKEN"];
        if (token) {
...
module.exports = __webpack_require__(/*! /Users/arivero/popular-movies/src/main.ts */"./src/main.ts");
